...
//         <h2 style={{color:"#A4C241" ,fontFamily:"Almarai" , fontSize:'3rem'}}>أهلا بك أيها المستخدم</h2>
//         <div style={{display:'flex' ,gap:"4rem"}}>
//           <Cards title='منتجاتنا' color="#283760" num="api" type="منتج" image={product}  />
//           <Cards_withCircleImage title='علاماتنا التجارية' num="api" color="#A4C241"  image={brand}   />
//           <Cards title='فئات' color="#58B0E0" type="فئة" image={category}  />

...
const BigNavigationLinks_Categories: React.FC<BigNavigationLinksProps> = ({
    navigateMain,
    navigateLinkMain,
    navigateLinkSubmain,
    navigateSubmain,
    ...
    return (
        <div className='BigNavigationLinks'>
            ...
            <Link to='/categories' className='Navigate-link'>{navigateLinkSubmain}</Link>
            <img src={arrow_navigate} alt="arrow_navigate" />
...
export default BigNavigationLinks_Categories
